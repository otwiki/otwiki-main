...
Entropic regularization modifies the Kantorovich problem by adding a [Kullback-Leibler divergence](https://en.wikipedia.org/wiki/Kullback%E2%80%93Leibler_divergence) term to the optimization goal. Specifically, the general form of the problem is now to determine
