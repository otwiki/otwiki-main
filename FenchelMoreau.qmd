...
The Fenchel-Moreau Theorem[^ref-brezis] is a fundamental result in convex analysis, characterizing the class of functions for which a function equals its biconjugate. A key consequence of this theorem is that is provides sufficient conditions for the equivalence of *primal* and *dual* optimization problems.[^ref-rockafellar]
...
[^ref-brezis]: [H. Brezis, *Functional Analysis, Sobolev Spaces, and Partial Differential Equations*, Chapter 1.](https://link.springer.com/book/10.1007/978-0-387-70914-7)

[^ref-rockafellar]: [R. T. Rockafellar and R. J-B. Wets, *Variational Analysis*, Chapter 11.](https://link.springer.com/book/10.1007/978-3-642-02431-3)
