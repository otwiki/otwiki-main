...
-   For each Gaussian measure $\mu$ on $X$, its covariance form $q$ is given by $q(f,g)=\langle f, S_\mu g\rangle$ for a unique positive semi-definite, self adjoint, trace class operator $S_\mu$.
