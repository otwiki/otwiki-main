...
The Kantorovich Dual Problem is one of the minimization problems in [Optimal Transport](index.qmd) . It is a dual problem of the [Kantorovich Problem](Kantorovich_Problem.qmd).
...
The proof of the previous Theorem can be found in [@bogachev2007measure]. For more information on $C_{b}(X)$ duality, take a look at [Dual space of C_0(x) vs C_b(x)](DualSpaceCtsFns.qmd).
