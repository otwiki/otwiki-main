...
If $\mu$ is absolutely continuous, then we can interchange the supremum and infimum [@Santambrogio2015] and [obtain](KDualProblem.qmd): $$ \sup_{\phi} \inf_{T} \int_{\Omega}\left( c(x, T(x)) - \phi(T(x)) \right) d \mu(x) + \int_{\Omega}\phi(y) d\nu(y) . $$
