...
One way to define the Hellinger-Kantorovich distance between positive measures is in the dynamic sense of [Benamou-Brenier](CtyEqn.qmd), [Dynamic Optimal Transport](https://otwiki.github.io/otwiki-main/Dynamic_OT.html) via
...
$$ 
using [Formal Riemannian Structure of Wasserstein Metric](RiemannianStructureOriginal.qmd) and Riemannian structure of Fischer-Rao metric [@de2025infimal]. Hence, we obtain
$$
