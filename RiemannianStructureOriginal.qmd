...
$\left\langle \frac{\partial \rho}{\partial t_1}, \frac{\partial \rho}{\partial t_2} \right\rangle_\rho = \int \rho \langle \nabla u_1, \nabla u_2 \rangle$[^ref-villani2] Here, $\frac{\partial \rho}{\partial t_1}, \frac{\partial \rho}{\partial t_2}$ are tangent vectors at $\rho$, and $u_1, u_2$ are solutions to the modified continuity equation from the previous section. This metric defines an inner product at every point in our space, $\mathcal{P}_2(X)$. This not only allows one to define [geodesics](GeoGenGeo.qmd) in this space, but the metric can be used to define calculus operators such as gradients and Hessians. These operators can be applied to in a similar manner to the same operators in finite dimensional Riemannian manifolds.

## References

[^ref-villani1]: [C. Villani, *Topics in Optimal Transportation*, p. 245-247](https://people.math.gatech.edu/~gangbo/Cedric-Villani.pdf)

[^ref-ambrosio-gigli-savare]: [L. Ambrosio, N. Gigli,G. Savaré, *Gradient Flows in Metric Spaces and in the Space of Probability Measures*, p. 189-191](https://link.springer.com/content/pdf/10.1007%2Fb137080.pdf)

[^ref-villani2]: [C. Villani, *Topics in Optimal Transportation*, p. 250-251](https://people.math.gatech.edu/~gangbo/Cedric-Villani.pdf)
