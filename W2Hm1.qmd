...
Furthermore, this asymptotic equivalence is relevant for evolution problems with the constraint $\varrho \leq 1$, such as crowd motion. [^ref-santambrogio]

## Formalization

### Definition of $\dot{H}^{-1}$

The negative Sobolev norm $\| \cdot \|_\dot{H}^{-1}$ is defined [^ref-santambrogio] [^ref-loeper] to be
...
Proof of the lemma can be found Chapter 5, page 210 of [^ref-santambrogio].

### $\dot{H}^{-1}$ as a Dual

This material is adapted from [^ref-peyre].
...
The proof of the theorem uses the above lemma and can be found Chapter 5, page 211 of [^ref-santambrogio].

## Localization

The following material is adapted from [^ref-peyre].
...
denotes the distance between a point $x$ and the subset $A$.
...
[^ref-santambrogio]: [F. Santambrogio, *Optimal Transport for Applied Mathematicians*, Chapter 5, pages 209-211](https://link-springer-com.proxy.library.ucsb.edu:9443/book/10.1007/978-3-319-20828-2)

[^ref-loeper]: <https://www.sciencedirect.com/science/article/pii/S0021782406000067> Loeper, Grégoire. *Uniqueness of the solution to the Vlasov–Poisson system with bounded density.* Journal de Mathématiques Pures et Appliquées, Volume 86, Issue 1, 2006, Pages 68-79, ISSN 0021-7824.

[^ref-peyre]: <https://arxiv.org/abs/1104.4631v2> Peyre, Rémi. *Comparison between* $W_2$ distance and $\dot{H}^{-1}$ norm, and localisation of Wasserstein distance.
