...
See [Analysis in Metric Spaces](Analysis_in_Metric_Spaces.qmd) for a review of these ideas.
...
See [The Continuity Equation and Benamou Brenier Formula](CtyEqn.qmd) and [Geodesics and Generalized Geodesics](GeoGenGeo.qmd) for more on these ideas.
